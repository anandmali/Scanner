 ...
 * {@link CameraSourceQr.Builder#setRequestedFps(float)} to specify a frame rate that works well with
...
public class CameraSourceQr {
    ...
    private static final String TAG = CameraSourceQr.class.getSimpleName();
    ...
    public static class Builder {
        ...
        private final CameraSourceQr mCameraSource = new CameraSourceQr();
    ...
    public CameraSourceQr start(SurfaceHolder surfaceHolder) throws IOException {
        synchronized (mCameraLock) {
            if (mCamera != null) {
                return this;
            }
     ...
     * <p/>
     * This camera source may be restarted again by calling {@link #start(SurfaceHolder)} or
    ...
    private Camera createCamera() {
        ...
        if (mFlashMode != null) {
            Log.e("Camera", parameters + " " + parameters.getSupportedFlashModes());
