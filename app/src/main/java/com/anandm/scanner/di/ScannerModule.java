...
public class ScannerModule {
    ...
    private static final String TAG = ScannerModule.class.getSimpleName();
    ...
    @Provides
    BarcodeDetector provideDetector(Context context) {
    ...
    @Provides
    CameraSourceQr createCameraSource(Context context, BarcodeDetector barcodeDetector) {
        ...
        // at long distances.
        CameraSourceQr.Builder builder = new CameraSourceQr.Builder(context.getApplicationContext(), barcodeDetector)
